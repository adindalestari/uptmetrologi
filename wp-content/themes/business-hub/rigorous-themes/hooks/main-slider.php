                ...
                <div id="main-slider">
                    <div class="owl-carousel">
                        ...
                        while ( $slider_query->have_posts() ) : $slider_query->the_post();
                            ...
                            $banner_style = '';
                            if( $image_url ){
                                $banner_style = 'style="background-image: url('.esc_url($image_url[0]).');"';
                            }
                            ?>

                            <div class="item" <?php echo wp_strip_all_tags($banner_style); ?>>
                                <div class="caption">
                                    <h2><?php the_title(); ?></h2>
                    ...
                    <div class="scroll-down-wrapper">
                        <div class="scroll-down">
                            <a href="#<?php echo esc_attr( 'scroll' ); ?>">
                ...
                if( !empty( $banner_img )){
                    ...
                    if ( $banner_img_query->have_posts() ) :
                        while ( $banner_img_query->have_posts() ) : $banner_img_query->the_post();
                            ...
                            $banner_style = '';
                            if( $image_url ){
                                $banner_style = 'style="background-image: url('.esc_url($banner_img_url[0]).');"';
                            }?>
