        ...
        <div class="container">
          <section class="our-services">
            <header class="entry-header heading">
              ...
              <h2 class="entry-title"><?php echo esc_html(get_the_category_by_ID( absint( $our_services ) ) ); ?> <span class="view-more"><a href="<?php echo esc_url(get_category_link( absint( $our_services ) )); ?>"><?php esc_html_e('View More', 'business-hub'); ?></a></span></h2>
            </header>
            <div class="services">
              <div class="row">
                <?php
        ...
        while ( $about_query->have_posts() ) : $about_query->the_post(); ?>
          ...
          <section class="about-us">
              <div class="left-part">
                  ...
                  <div class="entry-content">
                      <p><?php echo esc_html( business_hub_limit_words( get_the_excerpt(), 80 ) ); ?>  </p>
          ...
          <div class="container">
              <div class="row">
                  <div class="col col-1-of-1">
                      <header class="entry-header heading">
                          <span class=""><?php esc_html_e('Explore', 'business-hub'); ?></span>
                          <h2 class="entry-title"><?php echo esc_html(get_the_category_by_ID( absint( $our_works ) )); ?> <span class="view-more"><a href="<?php echo esc_url(get_category_link( absint( $our_works ) )); ?>"><?php esc_html_e('View More', 'business-hub'); ?></a></span></h2>
                      </header>
                  </div> <!-- .col -->
              </div><!-- .row -->
          </div><!-- .container -->
                        ...
                        <div class="hovereffect">
                          ...
                          <div class="overlay">
                              <div class="v-center">
                                  ...
                                  if ( $categories_list ) {
                                      printf( '<p><i class="fa fa-folder-open-o"></i> %1$s</p>', $categories_list ); // WPCS: XSS OK.
                                  }
                                  ?>
                              </div><!-- .v-center -->
                          </div><!-- .overlay -->
          ...
          <div class="container">
              <div class="row">
                  <div class="col col-1-of-1">
                    <header class="entry-header heading">
                      <span class=""><?php esc_html_e('Explore', 'business-hub'); ?></span>
                      <h2 class="entry-title"><?php echo esc_html(get_the_category_by_ID( absint( $our_blogs ) )); ?> <span class="view-more"><a href="<?php echo esc_url(get_category_link( absint( $our_blogs ) )); ?>"><?php esc_html_e('View More', 'business-hub'); ?></a></span></h2>
                    </header>
                  </div><!-- .col -->
                  <?php
                  $blog_args = array( 
