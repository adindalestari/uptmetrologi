...
class Business_Hub_Recent_Posts_Extended extends WP_Widget {
	...
	*/	
	...
	public function __construct() {
		...
		$widget_ops = array(						
            ...
            'description' 	=> esc_html__( 'A widget that displays your latest posts and thumbnail with extended features.', 'business-hub'),
            'customize_selective_refresh' => true,
        );

		parent::__construct('Business_Hub_Recent_Posts_Extended', esc_html__('Business Hub: Recent Post Extended', 'business-hub'), $widget_ops, $control_ops);
	...
	*/
	function widget($args, $instance){		
		...
		$title 				= ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Recent Posts', 'business-hub' );
