...
$thinkup_homepage_section4_url    = 'www.instagram.com';
...
$thinkup_homepage_section5_url    = 'http://localhost/uptmetrologi/index.php/alur-pelayanan/';
$thinkup_homepage_section5_button = thinkup_var ( 'thinkup_homepage_section5_button' );
$thinkup_homepage_section6_icon   = thinkup_var ( 'thinkup_homepage_section6_icon' );
$thinkup_homepage_section6_title  = thinkup_var ( 'thinkup_homepage_section6_title' );
$thinkup_homepage_section6_desc   = thinkup_var ( 'thinkup_homepage_section6_desc' );
$thinkup_homepage_section6_link   = thinkup_var ( 'thinkup_homepage_section6_link' );
$thinkup_homepage_section6_url    = 'https://forms.gle/DyFQvz5kgFJxCB166';
$thinkup_homepage_section6_button = thinkup_var ( 'thinkup_homepage_section6_button' );
	...
	if ( empty( $thinkup_homepage_section3_icon ) ) $thinkup_homepage_section3_icon = __( 'fa fa-money', 'grow' );
	if ( empty( $thinkup_homepage_section4_icon ) ) $thinkup_homepage_section4_icon = __( 'fa fa-newspaper-o', 'grow' );
	if ( empty( $thinkup_homepage_section5_icon ) ) $thinkup_homepage_section5_icon = __( 'fa fa-recycle', 'grow' );
	if ( empty( $thinkup_homepage_section6_icon ) ) $thinkup_homepage_section6_icon = __( 'fa fa-comment-o', 'grow' );
	...
	if ( empty( $thinkup_homepage_section4_title ) ) $thinkup_homepage_section4_title = __( 'Surat Permohonan', 'grow' );
	if ( empty( $thinkup_homepage_section5_title ) ) $thinkup_homepage_section5_title = __( 'Alur Pelayanan', 'grow' );
	if ( empty( $thinkup_homepage_section6_title ) ) $thinkup_homepage_section6_title = __( 'Pengaduan', 'grow' );
	...
	$thinkup_homepage_section4_desc = __( 'Surat Permohonan dapat digunakan SPBU untuk mengirim surat permohonan tera/tera ulang', 'grow' );

	if ( empty( $thinkup_homepage_section5_desc ) ) 
	$thinkup_homepage_section5_desc = __( 'Alur Pelayanan merupakan informasi tahapan pelayanan tera/tera ulang', 'grow' );

	if ( empty( $thinkup_homepage_section6_desc ) ) 
	$thinkup_homepage_section6_desc = __( 'Pengaduan merupakan laman pengaduan masyarakat berupa kritik & saran yang bersifat membangun', 'grow' );
	...
	if ( ! empty( $thinkup_homepage_section6_url ) ) {
		$thinkup_homepage_section6_link = $thinkup_homepage_section6_url;
	} else if ( ! empty( $thinkup_homepage_section6_link ) ) {
		$thinkup_homepage_section6_link = get_permalink( $thinkup_homepage_section6_link );
	}
	...
	if ( empty( $thinkup_homepage_section4_button ) )
		$thinkup_homepage_section4_button = __( 'Read More', 'grow' );
	if ( empty( $thinkup_homepage_section5_button ) )
		$thinkup_homepage_section5_button = __( 'Read More', 'grow' );
	if ( empty( $thinkup_homepage_section6_button ) )
		$thinkup_homepage_section6_button = __( 'Read More', 'grow' );
	...
	if ( is_front_page() ) {
		...
		echo '<div id="section-home"><div id="section-home-inner">';
			...
			echo '<article class="section5 one_third">',
					'<div class="services-builder style1">',
					'<div class="iconimage">';
			...
			echo '<article class="section6 one_third last">',
					'<div class="services-builder style1">',
					'<div class="iconimage">';
					if ( empty( $thinkup_homepage_section6_icon ) ) {
						echo '<i class="' . esc_attr( $thinkup_homepage_section6_icon ) . ' fa-2x fa-inverse"></i>';
					} else {
						if ( ! empty( $thinkup_homepage_section6_link ) ) {
							echo '<a href="' . esc_url( $thinkup_homepage_section6_link ) . '"><i class="' . esc_attr( $thinkup_homepage_section6_icon ) . ' fa-2x fa-inverse"></i></a>';
						} else {
							echo '<i class="' . esc_attr( $thinkup_homepage_section6_icon ) . ' fa-2x fa-inverse"></i>';
						}
					}
			echo	'</div>',
					'<div class="iconmain">',
					'<h3>' . esc_html( $thinkup_homepage_section6_title ) . '</h3>' . wpautop( do_shortcode( wp_strip_all_tags( esc_html( $thinkup_homepage_section6_desc ) ) ) );
					if ( ! empty( $thinkup_homepage_section6_link ) ) {
						echo '<p class="iconurl"><a class="" href="' . esc_url( $thinkup_homepage_section6_link ) . '">' . esc_html( $thinkup_homepage_section6_button ) . '</a></p>';
					}
			echo	'</div>',
					'</div>',
				'</article>';
...
$thinkup_homepage_introactioncustom1 = thinkup_var ( 'thinkup_homepage_introactioncustom1' );
	...
	if ( $thinkup_homepage_introswitch == '1' and is_front_page() and ! empty( $thinkup_homepage_introaction ) ) {
		...
		echo '<div id="introaction"><div id="introaction-core">';
			...
			if ( ( ! empty( $thinkup_homepage_introactionlink1) and $thinkup_homepage_introactionlink1 !== 'option6' ) ) {
