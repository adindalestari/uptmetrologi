...
<div id="body-core" class="hfeed site">
	...
	<div id="site-header">
		...
		<body>
			<h3>
			<a href=”http://profile.uptmetrologilegalpekanbaru.com/“><img style="float: left; margin:20px" src="<?php echo get_template_directory_uri(); ?>/images/logooo.png" width="420px" height="auto">
			<h3>
		</body>
		</html>
		<div id="header">
