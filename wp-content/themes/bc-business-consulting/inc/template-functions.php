              ...
              <div class="row">
                  ...
                  <div class="col-md-7 col-sm-7"> 
                    ...
                    <div class="pull-left">
                        ...
                        <?php
                        printf( /* translators:straing */  esc_html__( ': %1$s by %2$s.', 'bc-business-consulting' ), 'Business Consulting', '<a href="' . esc_url( __( 'https://athemeart.net/', 'bc-business-consulting' ) ) . '" target="_blank" rel="nofollow">' . esc_html__( 'aThemeArt', 'bc-business-consulting' ) . '</a>' ); ?>
